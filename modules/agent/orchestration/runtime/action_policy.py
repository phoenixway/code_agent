...
class ActionPolicyHandler:
    ...
    def _log_search_quality(self, command: dict):
        ...
        self.stage_logger.log(
            "search_quality",
            "warn" if quality["severity"] in {"warn", "block"} else "snapshot",
            kind=quality["kind"],
            severity=quality["severity"],
            reason=quality["reason"],
            boundedness_kind=quality.get("boundedness_kind"),
            boundedness_severity=quality.get("boundedness_severity"),
            boundedness_reason=quality.get("boundedness_reason"),
            tool_type=quality["tool_type"],
            path=quality["path"],
            path_validity=quality.get("path_validity"),
            expected_path_kind=quality.get("expected_path_kind"),
            actual_path_kind=quality.get("actual_path_kind"),
            path_validation_error_code=quality.get("path_validation_error_code"),
