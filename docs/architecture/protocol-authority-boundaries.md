...
| **`ResponsePipelineStagesMixin` (leaked system result check)** | `accessors.is_leaked_system_result` | Final-answer/plaintext guard | `TerminalAnswerClassifier` | Low | Phase 8 (Step 4L) |
