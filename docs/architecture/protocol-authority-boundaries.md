...
| **`ResponsePipelineStagesMixin` (leaked system result check)** | `accessors.is_leaked_system_result` | Final-answer/plaintext guard | `TerminalAnswerClassifier` (typed result primary signal plus legacy fallback) | Low | Phase 8 (Step 4L) |
